...
import { stepThree, stepTwo } from "../../../../../domain/redux/slices/create-order-flow";
import { useMySelector } from "../../../../../domain/hooks/my-selectior";

export const StepThreePage : React.FC<StepProps> = (props) => {
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", gap: 24}}>
            ...
            <NavButtons onSubmit={onSubmit} curPage={3} active={validity}/>
